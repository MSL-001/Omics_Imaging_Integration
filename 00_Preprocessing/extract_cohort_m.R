...
meanff_80 <- read.csv("male_mean_ff_VIBESegmentator_80.csv")
medianff_80 <- read.csv("male_median_ff_VIBESegmentator_80.csv")
volume_80 <- read.csv("male_vol_cm3_VIBESegmentator_80.csv")
meanff_100 <- read.csv("male_mean_ff_VIBESegmentator_100.csv")
medianff_100 <- read.csv("male_median_ff_VIBESegmentator_100.csv")
volume_100 <- read.csv("male_vol_cm3_VIBESegmentator_100.csv")

meanff_80_processed <- read.csv("male_mean_ff_VIBESegmentator_80_processed.csv")
medianff_80_processed <- read.csv("male_median_ff_VIBESegmentator_80_processed.csv")
volume_80_processed <- read.csv("male_vol_cm3_VIBESegmentator_80_processed.csv")
meanff_100_processed <- read.csv("male_mean_ff_VIBESegmentator_100_processed.csv")
medianff_100_processed <- read.csv("male_median_ff_VIBESegmentator_100_processed.csv")
volume_100_processed <- read.csv("male_vol_cm3_VIBESegmentator_100_processed.csv")
